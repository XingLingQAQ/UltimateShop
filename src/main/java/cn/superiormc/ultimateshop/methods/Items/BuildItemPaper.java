...
public class BuildItemPaper {
    ...
    public static ItemStack editItemStack(ItemStack item,
        ...
        if (displayNameKey != null) {
            item.setData(DataComponentTypes.CUSTOM_NAME, TextUtil.modernParse(displayNameKey, player));
        }

        // Item Name
        String itemNameKey = section.getString("item-name");
        if (itemNameKey != null) {
            item.setData(DataComponentTypes.ITEM_NAME, TextUtil.modernParse(itemNameKey, player));
        }
        ...
        if (!lores.isEmpty()) {
            ...
            for (String lore : lores) {
                ...
                for (String singleLore : lore.split("\n")) {
                    builder.addLine(TextUtil.modernParse(singleLore, player));
                }
            }
