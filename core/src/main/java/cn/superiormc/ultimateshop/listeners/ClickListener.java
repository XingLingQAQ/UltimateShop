...
public class ClickListener implements Listener {
    ...
    public void onInteract(PlayerInteractEvent event) {
        ...
        if (!UltimateShop.methodUtil.actionIsRightClick(event.getAction()) && ConfigManager.configManager.getString("sell.sell-stick.click-type", "RIGHT").equals("RIGHT")) {
            return;
        } else if (!UltimateShop.methodUtil.actionIsLeftClick(event.getAction()) && ConfigManager.configManager.getString("sell.sell-stick.click-type", "RIGHT").equals("LEFT")) {
            return;
        }
